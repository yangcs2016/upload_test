...
//                Toast.makeText(context, getResources().getString(R.string.alivc_upload_clear_list_finish), Toast.LENGTH_SHORT).show();
    ...
    private VodInfo getVodInfo() {
        ...
        vodInfo.setTitle(getResources().getString(R.string.alivc_upload_title) + "😄😄😄😄😄😄😄😄" + index);
...
//            vodInfo.setUserData(getResources().getString(R.string.alivc_upload_custom_data) + index);
        }
        return vodInfo;
    }
