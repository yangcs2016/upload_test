package android.src.main.java.yangcs2020.com.upload_plugin.aliyuncommon.widget;
...
public class WheelView extends View {
    ...
    public interface OnValueChangeListenerRelativeToRaw {
        void onValueChangeRelativeToRaw(WheelView picker, int oldPickedIndex, int newPickedIndex, String[] displayedValues);
    }
                    ...
                    if (msg.arg1 != msg.arg2) {
                        if (msg.obj == null || !(msg.obj instanceof Boolean) || (Boolean) msg.obj) {
                            if (mOnValueChangeListener != null) {
                                mOnValueChangeListener.onValueChange(WheelView.this, msg.arg1 + mMinValue, msg.arg2 + mMinValue);
                            }
                            if (mOnValueChangeListenerRaw != null) {
                                mOnValueChangeListenerRaw.onValueChangeRelativeToRaw(WheelView.this, msg.arg1, msg.arg2, mDisplayedValues);
                            }
                        }
                    }
